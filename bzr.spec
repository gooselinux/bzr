...
%changelog
* Fri May 21 2010 Jan Zeleny <jzeleny@redhat.com> - 2.1.1-2
- added -fno-strict-aliasing to build flags (strict aliasing seemed broken,
  but the code suggests it is intentionally this way)

* Tue May 04 2010 Jan Zeleny <jzeleny@redhat.com> - 2.1.1-1
- rebase to 2.1.1, many new features and bugfixes, see documentation for details

* Fri Nov 13 2009 Dennis Gregorovic <dgregor@redhat.com> - 2.0.2-1.1
- Fix conditional for RHEL

* Wed Nov 11 2009 Henrik Nordstrom <henrik@henriknordstrom.net> - 2.0.2-1
